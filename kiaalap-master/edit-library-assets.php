...
<head>
    ...
    <title>Modifier un Produit | Kiaalap - Kiaalap Admin Template</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Library Assets</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form method="POST" action="" class="dropzone dropzone-custom needsclick addlibrary" id="demo1-upload">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group res-mg-t-15">
                                                                    <input type="number" name="ID" value="<?PHP echo $ID ?>" class="form-control" placeholder="Type">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" name="Nom" value="<?PHP echo $Nom ?>" class="form-control" placeholder="Price" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="number" name="Prix" value="<?PHP echo $Prix ?>" class="form-control" placeholder="Year" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="number" name="Taille" value="<?PHP echo $Taille ?>" class="form-control" placeholder="Status">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress mg-t-15 responsive-mg-t-0">
                                                                    <button type="submit" name="modifier" class="btn btn-primary waves-effect waves-light">Modifier</button>
                                                    ...
                                                    if (isset($_POST['modifier'])){
                                                        $produit=new produits($_POST['Nom'],$_POST['ID'],$_POST['Prix'],$_POST['Taille']);
