...
{
$id=$_POST['id'];
$listeEvenement=$evenement1C->recupererEvent($id);
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                ?> 		
					<tr>
						...
						<td>
						 ...
						 <td>
						 <a href="../views/modifierEvent.php?id_event=<?PHP echo $row['id_event']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="modofier">&#xE254;</i></a>
						</td>
